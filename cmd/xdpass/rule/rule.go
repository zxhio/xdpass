...
func init() {
	...
	tcpCmd.PersistentFlags().BoolVarP(&F.TCP.FlagPSH, "psh", "P", false, "TCP flag PSH")
	tcpCmd.PersistentFlags().BoolVarP(&F.TCP.FlagRST, "rst", "R", false, "TCP flag RST")
	tcpCmd.PersistentFlags().BoolVarP(&F.TCP.FlagFIN, "fin", "F", false, "TCP flag FIN")
